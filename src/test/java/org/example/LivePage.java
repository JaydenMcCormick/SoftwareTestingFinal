...
public class LivePage {
    ...
    public void testHomepage() throws InterruptedException {
        ...
        WebElement showMore = chromeDriver.findElement(By.xpath("/html/body/ytd-app/div[1]/ytd-page-manager/ytd-browse[2]/ytd-two-column-browse-results-renderer/div[1]/ytd-rich-grid-renderer/div[6]/ytd-rich-section-renderer[1]/div/ytd-rich-shelf-renderer/div[1]/div[3]/ytd-button-renderer/yt-button-shape/button"));
        showMore.click();

        Thread.sleep(3000);

        // click show less
        WebElement showLess = chromeDriver.findElement(By.xpath("/html/body/ytd-app/div[1]/ytd-page-manager/ytd-browse[2]/ytd-two-column-browse-results-renderer/div[1]/ytd-rich-grid-renderer/div[6]/ytd-rich-section-renderer[1]/div/ytd-rich-shelf-renderer/div[1]/div[4]/ytd-button-renderer/yt-button-shape/button"));
        showLess.click();
